...
def amiCoSimulator():
	...
	initOption = "-Djava.class.path=." + os.pathsep + ":jdom.jar"
	libamico.amicoInitialize(1, initOption.encode('utf-8'))
	libamico.createMarioEnvironment(javaClass.encode('utf-8'))
	...
	return libamico, reset, getEntireObservation, performAction, getEvaluationInfo, getObservationDetails, options
